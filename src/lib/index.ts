...
export const LIGHTNESS_SCALE: Array<number | null> = [
  ...
  0.808, // 300
  0.704, // 400
  null, // 500 - base color lightness (calculated from input)
  0.577, // 600
  0.505, // 700
  0.444, // 800
  0.396, // 900
...
export const CHROMA_JITTER: Array<number> = [
  0.055, // 50 - very low chroma (0.013/0.237)
  0.135, // 100 (0.032/0.237)
  0.262, // 200 (0.062/0.237)
  0.481, // 300 (0.114/0.237)
  0.806, // 400 (0.191/0.237)
  1.0, // 500 - peak chroma
  1.034, // 600 (0.245/0.237) - slightly above peak
  0.899, // 700 (0.213/0.237)
  0.747, // 800 (0.177/0.237)
  0.595, // 900 (0.141/0.237)
  0.388, // 950 (0.092/0.237)
] as const
